...
func _ready():
	# line1 was given an end point in the scene, hence no need to declare one here
...
func _process(delta):
	...
	# get_collider() gives the object it collides with or else it stays empty if doesn't collide with anything.
